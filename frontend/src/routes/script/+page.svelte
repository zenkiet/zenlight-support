...
>
	<main class="relative flex min-w-0 flex-1 flex-col">
		...
		<div class="flex h-10 items-center space-x-3 bg-surface px-4 transition-colors duration-300">
			<button
				class="cursor-pointer rounded text-muted hover:text-primary disabled:text-muted/30 disabled:cursor-not-allowed"
			...
			<button
				class="cursor-pointer text-muted hover:text-main disabled:text-muted/30 disabled:cursor-not-allowed"
