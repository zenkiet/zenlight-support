      ...
      {:else}
        <div class="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
          ...
          {#if status === 'updating'}
            <div class="relative mb-6" in:scale={{ duration: 300 }}>
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <i class="size-6 animate-pulse text-blue-400 icon-[duotone--rotate]"></i>
              </div>
            </div>
          ...
          {:else if status === 'success'}
            ...
            >
              <span class="size-8 text-emerald-400 icon-[duotone--circle-check]"></span>
            </div>
          ...
          {:else if status === 'error'}
            <div
              ...
              in:scale={{ start: 0.5, duration: 400, easing: elasticOut }}
            >
              <i class="size-8 text-rose-400 icon-[duotone--circle-exclamation]"></i>
            </div>
